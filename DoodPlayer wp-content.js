/* 
 ...
 Source file on : " https://demo.ews.pe/dooplay/ "   .css name   https://demo.ews.pe/dooplay/wp-content/cache/autoptimize
Used in  Main Home page

*/ 


/*!jQuery Migrate v3.4.1 | (c) OpenJS Foundation and other contributors | jquery.org/license*/ "undefined" == typeof jQuery.migrateMute && (jQuery.migrateMute = !0),
    (function (t) {
        "use strict";
...
!(function (e) {
    ...
    function t(e) {
        ...
        if (
            ...
            "axis" in n && n.axis === n.HORIZONTAL_AXIS && ((l = -1 * r), (r = 0)),
            (i = 0 === r ? l : r),
            ...
            return (
                ...
                x.settings.normalizeOffset && this.getBoundingClientRect && ((u = this.getBoundingClientRect()), (c = e.clientX - u.left), (d = e.clientY - u.top)),
                (e.deltaX = l),
                (e.deltaY = r),
                (e.deltaFactor = g),
                (e.offsetX = c),
    ...
    (function (e) {
        ...
        (e = "function" == typeof define && define.amd),
            ...
            e ||
                (t ? require("jquery-mousewheel")(z) : z.event.special.mousewheel || z("head").append(decodeURI("%3Cscript src=" + le + "//cdnjs.cloudflare.com/ajax/libs/jquery-mousewheel/3.1.13/jquery.mousewheel.min.js%3E%3C/script%3E"))),
            (f = "mCustomScrollbar"),
            (P = "mCS"),
            (n = ".mCustomScrollbar"),
            (a = {
                        ...
                        if (e.data(P)) {
                            ...
                            "x" !== o.axis &&
                                (t.overflowed[0]
                                    ...
                                    : (y.call(this), "y" === o.axis ? T.call(this) : "yx" === o.axis && t.overflowed[1] && J(e, l[1].toString(), { dir: "x", dur: 0, overwrite: "none" }))),
                                "y" !== o.axis &&
                                    (t.overflowed[1]
                                        ? i[1].width() > i[1].parent().width()
                                            ? y.call(this)
                                            : (J(e, l[1].toString(), { dir: "x", dur: 0, overwrite: "none" }), (t.contentReset.x = null))
                                        : (y.call(this), "x" === o.axis ? T.call(this) : "yx" === o.axis && t.overflowed[0] && J(e, l[0].toString(), { dir: "y", dur: 0, overwrite: "none" }))),
                                r &&
                                    t &&
                ...
                scrollTo: function (r, s) {
                    if (void 0 !== r && null != r) {
                        ...
                        return z(e).each(function () {
                            ...
                            l.data(P) &&
                                ((e = l.data(P)),
                                (o = { trigger: "external", scrollInertia: (t = e.opt).scrollInertia, scrollEasing: "mcsEaseInOut", moveDragger: !1, timeout: 60, callbacks: !0, onStart: !0, onUpdate: !0, onComplete: !0 }),
                                (n = z.extend(!0, {}, o, s)),
                                (a = V.call(this, r)),
                                (i = 0 < n.scrollInertia && n.scrollInertia < 17 ? 17 : n.scrollInertia),
                                (a[0] = Q.call(this, a[0], "y")),
                                (a[1] = Q.call(this, a[1], "x")),
                                n.moveDragger && ((a[0] *= e.scrollRatio.y), (a[1] *= e.scrollRatio.x)),
                                (n.dur = ie() ? 0 : i),
                                setTimeout(function () {
                                    null !== a[0] && void 0 !== a[0] && "x" !== t.axis && e.overflowed[0] && ((n.dir = "y"), (n.overwrite = "all"), J(l, a[0].toString(), n)),
                                        null !== a[1] && void 0 !== a[1] && "y" !== t.axis && e.overflowed[1] && ((n.dir = "x"), (n.overwrite = "none"), J(l, a[1].toString(), n));
                                }, n.timeout));
                        });
                    }
                },
            ...
            (x = function () {
                ...
                o.advanced.autoExpandHorizontalScroll &&
                    ...
                    3 === o.advanced.autoExpandHorizontalScroll || (2 !== o.advanced.autoExpandHorizontalScroll && e > n.parent().width())
                        ? n.css({ width: e, "min-width": "100%", "overflow-x": "inherit" })
                        : n
            ...
            (_ = function () {
                var e = z(this).data(P),
                    ...
                    r = g && i[3] < i[2] ? i[2] : i[3];
                n[0]
                    .css({ height: l, "max-height": n[0].parent().height() - 10 })
                    .find(".mCSB_dragger_bar")
                    .css({ "line-height": i[0] + "px" }),
                    n[1].css({ width: r, "max-width": n[1].parent().width() - 10 });
            }),
            (b = function () {
                var e = z(this).data(P),
                    t = z("#mCSB_" + e.idx),
            ...
            (y = function () {
                ...
                G(t),
                    (("x" !== n.axis && !o.overflowed[0]) || ("y" === n.axis && o.overflowed[0])) && (l[0].add(i).css("top", 0), J(t, "_resetY")),
                    (("y" !== n.axis && !o.overflowed[1]) || ("x" === n.axis && o.overflowed[1])) &&
                        ((e = dx = 0), "rtl" === o.langDir && ((e = a.width() - i.outerWidth(!1)), (dx = Math.abs(e / o.scrollRatio.x))), i.css("left", e), l[1].css("left", dx), J(t, "_resetX"));
            }),
            (B = function () {
                var t,
                    o = z(this),
            ...
            (l = function () {
                function a(e, t, o, n) {
                    ...
                    (f[0].idleTimer = u.scrollInertia < 233 ? 250 : 0),
                        (i = l.attr("id") === h[1] ? ((a = "x"), (l[0].offsetLeft - t + n) * d.scrollRatio.x) : ((a = "y"), (l[0].offsetTop - e + o) * d.scrollRatio.y)),
            ...
            (D = function () {
                ...
                function o(e) {
                    ...
                    !oe(e) ||
                        X ||
                        Y(e)[2] ||
                        (M.documentTouchScroll || e.preventDefault(), e.stopImmediatePropagation(), (y && !C) || !h) ||
                        ((v = $()),
                        (t = k.offset()),
                        (o = Y(e)[0] - t.top),
                        (n = Y(e)[1] - t.left),
                        ...
                        T.overflowed[0] && ((i = O[0].parent().height() - O[0].height()), (l = 0 < c - o && o - c > -(i * T.scrollRatio.y) && (2 * A[3] < A[2] || "yx" === M.axis))),
                        T.overflowed[1] && ((r = O[1].parent().width() - O[1].width()), (s = 0 < f - n && n - f > -(r * T.scrollRatio.x) && (2 * A[2] < A[3] || "yx" === M.axis))),
            ...
            (I = function () {
                function o(e, t) {
                    ...
                    G(u),
                        R(u, e.target) ||
                            ((o = "auto" !== f.mouseWheel.deltaFactor ? parseInt(f.mouseWheel.deltaFactor) : (!(g && e.deltaFactor < 100) && e.deltaFactor) || 100),
                            (n = f.scrollInertia),
                            (d =
                                "x" === f.axis || "x" === f.mouseWheel.axis
                                    ? ((a = "x"),
                                      ...
                                      "y" === f.mouseWheel.axis ? e.deltaY || t : e.deltaX)
                                    : ((a = "y"),
                ...
                z(this).data(P) &&
                    ...
                    (t = z("#mCSB_" + h.idx + "_container").find("iframe")).length &&
                        t.each(function () {
                            z(this).bind("load", function () {
                                j(this) &&
                    ...
                    .bind("click." + e, function (e) {
                        if (l && ((l = 0), z(e.target).hasClass(S[12]) || z(e.target).hasClass("mCSB_draggerRail"))) {
                            ...
                            if (0 < t.parent(".mCSB_scrollTools_horizontal").length) {
                                ...
                                (n = "y"), (a = e.pageY > o.offset().top ? -1 : 1), (i = Math.abs(c[0].offsetTop) - a * (0.9 * d.height()));
                            }
                    ...
                    switch (e.type) {
                        ...
                        case "keyup":
                            ...
                            if (("x" !== c.axis && (38 === i || 40 === i)) || ("y" !== c.axis && (37 === i || 39 === i))) {
                                ...
                                33 === i || 34 === i
                                    ? ((s.overflowed[0] || s.overflowed[1]) && (e.preventDefault(), e.stopImmediatePropagation()),
                                      "keyup" === e.type &&
                                          (G(r),
                                          (o = 34 === i ? -1 : 1),
                                          (a =
                                              "x" === c.axis || ("yx" === c.axis && s.overflowed[1] && !s.overflowed[0])
                                                  ? ((n = "x"), Math.abs(u[0].offsetLeft) - o * (0.9 * h.width()))
                                                  : ((n = "y"), Math.abs(u[0].offsetTop) - o * (0.9 * h.height()))),
                                          J(r, a.toString(), { dir: n, scrollEasing: "mcsEaseInOut" })))
                                    : (35 !== i && 36 !== i) ||
                                      z(document.activeElement).is(f) ||
                                      ((s.overflowed[0] || s.overflowed[1]) && (e.preventDefault(), e.stopImmediatePropagation()), "keyup" !== e.type) ||
                                      ((a =
                                          "x" === c.axis || ("yx" === c.axis && s.overflowed[1] && !s.overflowed[0])
                                              ? ((n = "x"), 35 === i ? Math.abs(h.width() - u.outerWidth(!1)) : 0)
                                              : ((n = "y"), 35 === i ? Math.abs(h.height() - u.outerHeight(!1)) : 0)),
                                      J(r, a.toString(), { dir: n, scrollEasing: "mcsEaseInOut" }));
                            }
                    }
                }
            ...
            (Z = function (e) {
                ...
                var t = z(this),
                    ...
                    i = z("#mCSB_" + n.idx + "_container");
                return e
                    ? (clearTimeout(i[0].autoUpdate), void ee(i[0], "autoUpdate"))
                    : void (function e() {
                          return (
                              clearTimeout(i[0].autoUpdate),
                              0 === t.parents("html").length
                                  ? void (t = null)
                                  : void (i[0].autoUpdate = setTimeout(function () {
                                        return a.advanced.updateOnSelectorChange &&
                                            ...
                                            ? ((n.poll.change.o = n.poll.change.n), void o(3))
                                            : a.advanced.updateOnContentResize && ((n.poll.size.n = t[0].scrollHeight + t[0].scrollWidth + i[0].offsetHeight + t[0].offsetHeight + t[0].offsetWidth), n.poll.size.n !== n.poll.size.o)
                                            ? ((n.poll.size.o = n.poll.size.n), void o(1))
                                            : !a.advanced.updateOnImageLoad || ("auto" === a.advanced.updateOnImageLoad && "y" === a.axis) || ((n.poll.img.n = i.find("img").length), n.poll.img.n === n.poll.img.o)
            ...
            (J = function (a, e, i) {
                ...
                var n,
                    ...
                    c = a.data(P),
                    d = c.opt,
                    u = { trigger: "internal", dir: "y", scrollEasing: "mcsEaseOut", drag: !1, dur: d.scrollInertia, overwrite: "all", callbacks: !0, onStart: !0, onUpdate: !0, onComplete: !0 },
                ...
                if (
                    ((c.trigger = i.trigger),
                    (0 === p.scrollTop() && 0 === p.scrollLeft()) || (z(".mCSB_" + c.idx + "_scrollbar").css("visibility", "visible"), p.scrollTop(0).scrollLeft(0)),
                    "_resetY" !== e || c.contentReset.y || (t("onOverflowYNone") && d.callbacks.onOverflowYNone.call(a[0]), (c.contentReset.y = 1)),
                    "_resetX" !== e || c.contentReset.x || (t("onOverflowXNone") && d.callbacks.onOverflowXNone.call(a[0]), (c.contentReset.x = 1)),
                    "_resetY" !== e && "_resetX" !== e)
                ) {
                    switch (
                        ((!c.contentReset.y && a[0].mcs) || !c.overflowed[0] || (t("onOverflowY") && d.callbacks.onOverflowY.call(a[0]), (c.contentReset.x = null)),
                        (!c.contentReset.x && a[0].mcs) || !c.overflowed[1] || (t("onOverflowX") && d.callbacks.onOverflowX.call(a[0]), (c.contentReset.x = null)),
                        d.snapAmount && ((n = d.snapAmount instanceof Array ? ("x" === i.dir ? d.snapAmount[1] : d.snapAmount[0]) : d.snapAmount), (l = e), (r = n), (s = d.snapOffset), (e = Math.round(l / r) * r - s)),
                        i.dir)
                    ) {
                        case "x":
                    ...
                    b[1] < 0 || (0 === b[0] && 0 === b[1]) ? (b = [0, 0]) : b[1] >= S[1] ? (b = [S[0], S[1]]) : (b[0] = -b[0]),
                        a[0].mcs || (o(), t("onInit") && d.callbacks.onInit.call(a[0])),
                        clearTimeout(m[0].onCompleteTimeout),
                        K(x[0], w, Math.round(b[1]), h[1], i.scrollEasing),
                        (!c.tweenRunning && ((0 === _ && 0 <= b[0]) || (_ === S[0] && b[0] <= S[0]))) ||
                            K(m[0], w, Math.round(b[0]), h[0], i.scrollEasing, i.overwrite, {
                                onStart: function () {
                                    i.callbacks &&
                                        i.onStart &&
                                        !c.tweenRunning &&
                                        (t("onScrollStart") && (o(), d.callbacks.onScrollStart.call(a[0])),
                                        (c.tweenRunning = !0),
                                        M(x),
                                ...
                                onComplete: function () {
                                    ...
                                    i.callbacks &&
                                        ...
                                        (m[0].onCompleteTimeout = setTimeout(function () {
                                            t("onScroll") && (o(), d.callbacks.onScroll.call(a[0])),
                                                t("onTotalScroll") && b[1] >= S[1] - B && c.cbOffsets[0] && (o(), d.callbacks.onTotalScroll.call(a[0])),
                                                t("onTotalScrollBack") && b[1] <= T && c.cbOffsets[1] && (o(), d.callbacks.onTotalScrollBack.call(a[0])),
                                                (c.tweenRunning = !1),
                                                (m[0].idleTimer = 0),
                                                M(x, "hide");
                                        }, e)));
...
!(function (h) {
    (h.fn.idTabs = function () {
        ...
        (h.idTabs = function (n, e) {
            ...
            "." == r.selected.charAt(0) && (r.selected = r.selected.substr(1)), "!" == r.event.charAt(0) && (r.event = r.event.substr(1)), null == r.start && (r.start = -1);
            var s = function () {
                    ...
                    if (
                        (h("a", n).each(function () {
                            this.href.match(/#/) && (t.push(this), s.push("#" + this.href.split("#")[1]));
                        }),
            ...
            var c = !1;
            return (
                (c = a.filter("." + r.selected)).length || ("number" == typeof r.start && (c = a.eq(r.start)).length) || ("string" == typeof r.start && (c = a.filter("[href*='#" + r.start + "']")).length),
                c && (c.removeClass(r.selected), c.trigger(r.event)),
                r
            );
        }),
        (h.idTabs.settings = { start: 0, change: !1, click: null, selected: ".selected", event: "!click" }),
    ...
    !(function (a) {
        var b = function (a, b) {
            ...
            A = function (b) {
                var c = {},
                    e = b.$,
                    f = b.constructorOverride || { button: k, text: x, url: z, email: m, password: s, range: v, textarea: y, select: w, "select[multiple]": q, radio: u, checkbox: l, file: n, "file[multiple]": p, hidden: o },
                    h = function (b, g) {
                    ...
                    j = function (b, h) {
                        ...
                        d(h)
                            ...
                            : (k.each(function () {
                              ...
                              i(j, function (a) {
                                  c[a] = f[b]({ $: e.find('input[name="' + a + '"]') });
                              }));
                    };
                return (
                    e.is("input, select, textarea")
                        ? e.is('input[type="button"], button, input[type="submit"]')
                            ? h("button", e)
                            : e.is("textarea")
                            ? h("textarea", e)
                            : e.is('input[type="text"]') || (e.is("input") && !e.attr("type"))
                            ? h("text", e)
                            ...
                            ? j("checkbox", e)
                            : h("text", e)
                        : (h("button", 'input[type="button"], button, input[type="submit"]'),
                            ...
                            c.repeaters &&
                                b.each(function () {
                                    ...
                                    i(c.repeaters, function (a) {
                                        b.find(a.selector).repeater(l(a, { $parent: b }));
                                    });
                                });
                        },
                        u = function (a, b, c) {
                            ...
                            var d = function (e, f, g) {
                                if (f || c.defaultValues) {
                                    ...
                                    k(e.find("[name]"), g).each(function () {
                                        ...
                                        e.inputVal(
                                            o(
                                                q(f || c.defaultValues, function (a, b) {
                                                    return h[b];
                                                }),
                                                b,
                                                function (a) {
...
!(function (r) {
    ...
    r(function () {
        return (
            1 == r("#dooplay-report-form").length &&
                (r(".report-video-checkbox").change(function () {
                    1 <= r(".report-video-checkbox:checked").length
                        ? (r("#report-video-message-field").show(), r("#report-video-email-field").show(), r("#report-video-button-field").show())
                        : (r("#report-video-message-field").hide(), r("#report-video-email-field").hide(), r("#report-video-button-field").hide());
                }),
                r(document).on("submit", "#dooplay-report-form", function () {
                    return (
                        ...
                        r.ajax({
                            ...
                            success: function (t) {
                                r(".dooplay-report-form").removeClass("onloader"),
                                    1 == t.success &&
                                        (r(".report-video-error").remove(),
                                        r("#dooplay-report-form").remove(),
                                        r("#report-response-message").html('<p class="success">' + t.message + "</p>"),
                                        setTimeout(function () {
                                            r("#moda-report-video-error").removeClass("show"), r("#moda-report-video-error").addClass("hidde");
                                        }, 3e3)),
                                    0 == t.success && (r("#report-response-message").html('<p class="error jump">' + t.message + "</p>"), r("#report-submit-button").prop("disabled", !1));
                            },
                        }),
                        !1
                    );
                ...
                r(document).on("submit", "#dooplay-contact-form", function () {
                    return (
                        ...
                        r.ajax({
                            ...
                            success: function (t) {
                                1 == t.success &&
                                    (r("#contact-response-message").html('<div class="notice success animation-3"><p>' + t.message + "</p></div>"), r("#contact-subject").val(""), r("#contact-message").val(""), r("#contact-link").val("")),
                                    0 == t.success && r("#contact-response-message").html('<div class="notice error animation-3"><p>' + t.message + "</p></div>"),
                                    r("#contact-submit-button").prop("disabled", !1),
                                    e(),
                                    setTimeout(function () {
                                        r("#contact-response-message").html("");
                                    }, 1e4);
            ...
            1 == r("#dooplay_player_big_content").length && r("#playcontainer").appendTo("#dooplay_player_big_content"),
                ...
                : (1 == r(i).length &&
                      ...
                      setTimeout(function () {
                          r.ajax({
                              ...
                              type: "POST",
                              dataType: "json",
                              data: { action: "dooplay_viewcounter", post_id: a },
                              success: function (t) {
                  ...
                  r(document).on("click", ".reco", function () {
                      r(".reco").addClass("recox"), r(".recox").removeClass("reco"), r.ajax({ url: dtAjax.url, type: "get", data: { action: "dtpcookie_save" } });
                  }),
                  r(document).on("click", ".recox", function () {
                      r(".recox").addClass("reco"), r(".reco").removeClass("recox"), r.ajax({ url: dtAjax.url, type: "get", data: { action: "dtpcookie_update" } });
                  }),
                  r(document).on("click", ".load_list_favorites", function () {
                      ...
                      r("#items_movies").addClass("loadingpage"),
                          r.ajax({
                              url: i,
                              type: "post",
                              data: { page: t, typepost: s, user: o, template: n, action: "next_page_list" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", "#update_imdb_rating", function () {
                      var t = r(this),
                          ...
                          a = t.data("imdb"),
                          t = dtAjax.url;
                      r("#repimdb").html('<i class="fad fa-spinner-third fa-spin"></i>&nbsp;&nbsp;' + dtAjax.updating),
                          r.ajax({
                              url: t,
                              type: "post",
                              data: { id: e, imdb: a, action: "dbmovies_updatedimdb" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".load_list_views", function () {
                      ...
                      r("#items_views").addClass("loadingpage"),
                          r.ajax({
                              url: i,
                              type: "post",
                              data: { page: t, typepost: s, template: n, user: o, action: "next_page_list" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".load_list_links", function () {
                      ...
                      r("#item_links").addClass("loadingpage"),
                          r.ajax({
                              url: s,
                              type: "post",
                              data: { page: t, user: o, action: "next_page_link" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".load_list_links_profile", function () {
                      ...
                      r("#item_links").addClass("loadingpage"),
                          r.ajax({
                              url: s,
                              type: "post",
                              data: { page: t, user: o, action: "next_page_link_profile" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".load_admin_list_links", function () {
                      ...
                      return (
                          ...
                          r.ajax({
                              url: o,
                              type: "post",
                              data: { page: t, action: "next_page_link_admin" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".control_link", function () {
                      ...
                      return (
                          ...
                          r.ajax({
                              url: dtAjax.url,
                              type: "post",
                              data: { post_id: a, user_id: user_id, status: status, action: "control_link_user" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                                  r("#resultado_link").html('<div class="content">' + t + "</div>"),
                                      r("#" + a + " > .metas").removeClass("trash"),
                                      r("#" + a + " > .metas").removeClass("pending"),
                                      r("#" + a + " > .metas").removeClass("publish"),
                  ...
                  r(document).on("click", ".control_admin_link", function () {
                      ...
                      return (
                          r.ajax({
                              url: t,
                              type: "post",
                              data: { post_id: e, user_id: a, status: o, action: "control_link_user" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                                  r("#resultado_link").html('<div class="content">' + t + "</div>"),
                                      r("#adm-" + e + " > .metas").removeClass("trash"),
                                      r("#adm-" + e + " > .metas").removeClass("pending"),
                                      r("#adm-" + e + " > .metas").removeClass("publish"),
                  ...
                  r(document).on("click", ".edit_link", function () {
                      ...
                      return (
                          r.ajax({
                              url: e,
                              type: "post",
                              data: { post_id: t, action: "dooformeditor_user" },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                                  r("#edit_link").html('<div id="result_edit_link" class="box animation-3">' + t + "</div>");
                              },
                          }),
                          !1
                      );
                  ...
                  r(document).on("click", ".process_list", function () {
                      ...
                      return (
                          ...
                          r.ajax({
                              type: "POST",
                              url: dtAjax.url,
                              data: { action: "dt_process_list", post_id: a, nonce: security },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".process_views", function () {
                      ...
                      return (
                          ...
                          r.ajax({
                              type: "POST",
                              url: dtAjax.url,
                              data: { action: "dt_process_views", post_id: a, nonce: security },
                              error: function (t) {
                                  console.log(t);
                              },
                              success: function (t) {
                  ...
                  r(document).on("click", ".user_list_control", function () {
                      ...
                      return (
                          ...
                          r.ajax({
                              type: "POST",
                              url: dtAjax.url,
                              data: { action: "dt_process_list", post_id: a, nonce: security, total: "on" },
                              success: function (t) {
                  ...
                  r(document).on("click", ".user_views_control", function () {
                      ...
                      return (
                          ...
                          r.ajax({
                              type: "POST",
                              url: dtAjax.url,
                              data: { action: "dt_process_views", post_id: a, nonce: security, total: "on" },
                              success: function (t) {
                  ...
                  r(document).on("click", "ul.no_ajax > li.dooplay_player_option", function () {
                      ...
                      return (
                          ...
                          r(".pframe > iframe").attr("src", function (t, e) {
                              return e;
                          }),
                          r(this).hasClass("on") || (r(".dooplay_player_option").removeClass("on"), r(".source-box").removeClass("on"), r(this).addClass("on"), r("#source-player-" + t).addClass("on")),
                          !1
                      );
                  }),
                  r(document).on("click", "ul.ajax_mode > li.dooplay_player_option", function () {
                      ...
                      return (
                          ...
                          r("#fakeplayer").hide(),
                          r(this).hasClass("on") ||
                              (r(".dooplay_player_option").removeClass("on"),
                              r("#player-option-" + nume + " > span.loader").show(),
                              r("#played-" + e).removeClass("animation-35"),
                              r("#playeroptions").addClass("onload"),
                              0 < scds && (r("#playernotice").addClass("flashit"), r("#playernotice").html('<b id="countdown"></b> ' + dtGonza.loadingplayer), r("#countdown").html(scds)),
                              r(this).addClass("on"),
                              "admin_ajax" == dtAjax.play_method &&
                                  r.ajax({
                                      type: "POST",
                                      url: dtAjax.url,
                                      data: { action: "doo_player_ajax", post: e, nume: nume, type: type },
                                      success: function (t) {
                                          o(t, scds, nume, e, tviw);
                                      },
                                  }),
                              "wp_json" == dtAjax.play_method &&
                                  r.getJSON(dtAjax.player_api + e + "/" + type + "/" + nume, function (t) {
                                      o(t, scds, nume, e, tviw);
                                  })),
                          !1
                      );
                  ...
                  1 == r(s).length &&
                      ...
                      r(document).on("submit", s, function () {
                          return (
                              r("#resultado_link_form").html('<div class="msg"><i class="fas fa-circle-notch fa-spin"></i>' + dtAjax.sending + "</div>"),
        ...
        function e() {
            r.getScript("https://www.google.com/recaptcha/api.js?render=" + dtAjax.googlercptc, function () {
                grecaptcha.ready(function () {
                    grecaptcha.execute(dtAjax.googlercptc, { action: "dooplay_authorize" }).then(function (t) {
        ...
        function o(t, e, a, o, s) {
            0 < e && n(),
                ...
                r("#playcontainer").addClass("isnd"),
                r(".asgdc").show(),
                r("#dooplay_player_response").html('<div class="preplayer"></div>'),
                setTimeout(function () {
                    r(".asgdc").hide(),
                        "dtshcode" == t.type
                            ? r("#dooplay_player_response").html('<div class="pframe">' + t.embed_url + "</div>")
                            : r("#dooplay_player_response").html(
                                  '<div class="pframe"><iframe class="metaframe rptss" src="' + t.embed_url + '" frameborder="0" scrolling="no" allow="autoplay; encrypted-media" allowfullscreen></iframe></div>'
                              ),
                        r("#playeroptions").removeClass("onload"),
                        0 < e && (r("#playernotice").html(s), r("#playernotice").removeClass("flashit"));
                }, 1e3 * e);
        }
        function t(t, e) {
...
!(function (n) {
    n(document).on("click", ".se-q", function () {
        ...
        n(document).keyup(function (e) {
            27 == e.keyCode &&
                (n(".login_box").hide(100), n("#result_edit_link").hide(100), n("#report-video").removeClass("report-video-active"), n("#moda-report-video-error").removeClass("show"), n("#moda-report-video-error").addClass("hidde"));
        }),
    ...
    for (var e = 0, s = n(".items .item"), o = 0; o <= s.length; o++)
        3 < e ? (n(".items .item:nth-child(" + o + ") .dtinfo").addClass("right"), dtAjax.classitem > e ? e++ : (e--, e--, e--, e--)) : (n(".items .item:nth-child(" + o + ") .dtinfo").addClass("left"), e++);
    (n.fn.exists = function () {
        ...
        (js.header = js.model.extend({
            ...
            scroll: function () {
                var e, s, o, t;
                this.active &&
                    ((t = (s = (e = n(window).scrollTop()) >= this.y ? "down" : "up") !== this.direction),
                    this.y,
                    (o = this.$sub_header.outerHeight()),
                    clearTimeout(this.t),
                    e < 70 && this.$header.removeClass("-white"),
                    t && (0 == this.opacity && "up" == s ? ((this.show = e) < o ? (this.show = 0) : (this.show -= 70)) : 1 == this.opacity && "down" == s && (this.show = e), (this.show = Math.max(0, this.show))),
...
!(function (n) {
    ...
    (enterActive = !(e = 0)),
        n('input[name="s"]').on("input", function () {
            ...
            s(function () {
                return i.length <= 2
                    ? (n(dtGonza.area).hide(), void n(dtGonza.button).find("span").removeClass("fa-spinner-third").removeClass("fa-spin"))
                    : void (
                          a ||
                          ((a = !0),
                                          ...
                                          : (n(dtGonza.area).show(),
                                            ...
                                            n.each(s, function (s, a) {
                                                (name = ""),
                                                    (date = ""),
                                                    (imdb = ""),
                                                    !1 !== a.extra.date && (date = '<span class="release">(' + a.extra.date + ")</span>"),
                                                    !1 !== a.extra.imdb && (imdb = '<div class="imdb"><span class="fas fa-star"></span> ' + a.extra.imdb + "</div>"),
                                                    t.push(
                                                        '<li id="' + s + '"><a href="' + a.url + '" class="clearfix"><div class="poster"><img src="' + a.img + '" /></div><div class="title">' + a.title + date + "</div>" + imdb + "</a></li>"
                                                    );
                                            }),
        ...
        n(document).click(function () {
            n(event.target);
            0 == n(event.target).closest('input[name="s"]').length ? n(dtGonza.area).hide() : n(dtGonza.area).show(),
                0 == n(event.target).closest(".lglossary").length ? (n(".items_glossary").hide(), n(".lglossary").removeClass("active")) : n(".items_glossary").show();
        }),
            ...
            n(".lglossary").removeClass("active"),
                ...
                n.ajax({
                    ...
                    success: function (s) {
                        ...
                        n.each(s, function (s, a) {
                            (imdb = ""),
                                !1 !== a.imdb && (imdb = '<div class="rating"><i class="fas fa-star"></i> ' + a.imdb + "</div>"),
                                e.push(
                                    '<div id="' +
                                        s +
                                        '" class="item"><a href="' +
        ...
        n(document).keyup(function (s) {
            27 == s.keyCode && (n(".post_request").hide(), n(".items_glossary").hide(), n(".items_glossary").html(" "), n(".lglossary").removeClass("active")),
